...
/**
 * Class PhoneNoticeBalanceMonthController
 * @package console\controllers
 * консольная комманда, которая в начале месяца должна мониторить баланс пользователя и наличие подписки и продлевать до конца месяца
 */

class PhoneNoticeBalanceMonthController extends Controller
{
